/**
 * Simplified test script for AppRegistry implementation
 * This version mocks dependencies to avoid native module compilation issues
 */
...
class MockDatabase {
  ...
  prepare(sql) {
    return {
      run: (...args) => ({ changes: 1 }),
      get: (key) => this.data.get(key) || null,
...
require = function(id) {
  switch(id) {
    ...
    case 'better-sqlite3': return MockDatabase;
    default: return originalRequire(id);
  }
};
